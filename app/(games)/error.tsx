...
export default function GamesError({
  ...
  return (
    <div className="flex h-dvh items-center justify-center bg-shell-dark p-4">
      <div className="flex w-full max-w-sm flex-col items-center rounded-3xl bg-white p-8 text-center shadow-xl">
        ...
        <h2 className="mb-2 text-2xl font-extrabold text-slate-700">Trò chơi bị lỗi</h2>
        <p className="mb-6 text-lg text-slate-500">Thử lại ngay nhé!</p>
        <button
          type="button"
          onClick={reset}
