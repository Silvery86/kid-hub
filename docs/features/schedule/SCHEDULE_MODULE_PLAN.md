...
**Status:** ⚠️ Superseded — see [SCHEDULE_MODULE_PLAN_v2.html](./SCHEDULE_MODULE_PLAN_v2.html) for implementation audit
**Authors:** PM · Lead Dev · Designer · QA
**Route:** `/schedule` (inside `app/(dashboard)/schedule/`)
**Date:** 2026-05-16 · **Moved:** 2026-05-30 → `docs/features/schedule/`
...
*Document status: Historical v1 reference. Backend/parent tools shipped; kid-facing evening + homework integration incomplete. Review [SCHEDULE_MODULE_PLAN_v2.html](./SCHEDULE_MODULE_PLAN_v2.html) and [SCHEDULE_DESIGN.html](./SCHEDULE_DESIGN.html) for current state.*
