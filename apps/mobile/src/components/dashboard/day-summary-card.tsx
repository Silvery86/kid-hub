  ...
  return (
    <View
      ...
      <View className="h-11 w-11 items-center justify-center rounded-chip bg-schedule-soft">
        <Text className="font-display-bold text-[22px] text-schedule-deep">{periodCount}</Text>
      </View>

      <View className="min-w-0 flex-1">
        <Text className="font-display-bold text-[15px] text-text-primary">
          {dayLabel}
      ...
      {isToday ? (
        <View className="rounded-pill bg-schedule px-2.5 py-1">
          <Text className="font-display-bold text-[11px] text-white">Hôm nay</Text>
        </View>
      ) : null}
    </View>
  )
