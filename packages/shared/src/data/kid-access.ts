/**
 * Kid access feature toggles — UI state; persisted in localStorage on the parent
 * kid-access page (web) and via the kid-access endpoint (mobile).
 * Owner: @kid-hub/shared — apps/web/lib/data/kid-access.ts re-exports these.
 */
