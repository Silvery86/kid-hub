 ...
 * Owner: @kid-hub/shared — apps/web/lib/data/badges.ts re-exports these.
 */
...
export const BADGE_DEFINITIONS: readonly BadgeDefinition[] = [
  ...
  { id: 'math-ace', name: 'Siêu Toán', description: 'Đạt xuất sắc môn Toán', iconEmoji: '🧮' },
  {
    id: 'reading-star',
    name: 'Sao Đọc Sách',
    description: 'Đạt xuất sắc Tiếng Việt',
    iconEmoji: '📚',
  },
  {
    id: 'english-hero',
    name: 'Anh hùng Tiếng Anh',
    description: 'Hoàn thành game Tiếng Anh',
    iconEmoji: '🌍',
  },
  ...
  { id: 'game-win', name: 'Chiến thắng!', description: 'Hoàn thành 1 trò chơi', iconEmoji: '🎮' },
  {
    id: 'top-score',
    name: 'Điểm cao nhất',
    description: 'Đạt điểm cao nhất trong game',
    iconEmoji: '🏆',
  },
] as const
